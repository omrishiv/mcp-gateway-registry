"""Unit tests for the generic-proxy nginx block generation (Task #7).
...
class TestFetchFlagGate:
    async def test_disabled_flag_issues_zero_queries(self):
        """BLOCKER (SRE): when the feature is off, NOT ONE repo query fires."""
...
class TestSafeBlock:
    ...
    def test_dollar_in_target_skipped(self):
        ...
        # expanded by nginx as a variable reference (kiro P2). Must be rejected.
    ...
    def test_illegal_entity_type_skipped(self):
        ...
        # interpolated into 4 directive positions — reject it (kiro P2).
    ...
    def test_path_traversal_segment_skipped(self):
        ...
        # normalizes the proxy_pass URI (kiro P2).
    ...
    def test_empty_auth_server_url_skipped(self):
        ...
        # self-loop. Skip rather than emit a bad block (kiro P3).
