...
The OAuth AS-facade surface (discovery docs, DCR, the PKCE auth-code store) was
removed when the egress consent flow switched to MCP URL-mode elicitation; only
the small path/config helpers remain.
"""
