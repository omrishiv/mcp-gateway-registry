"""Tests that the ProxyableMixin is correctly wired into every entity model (B1).
...
class TestServiceLayerRoundTrip:
    ...
    that previously dropped the fields, per the cold review)."""
    ...
    def test_custom_create_source_copies_proxy_fields(self):
        ...
        Guards the specific two-line carry-through the cold review found missing
