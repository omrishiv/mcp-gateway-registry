      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        >
          ...
          {/* Backend OAuth 2.0 (client_credentials) config — shown when the scheme
              is `oauth`. Registry-only safe. Saved via PUT /servers/{path}/oauth-config. */}
          ...
          {/* Discovery Identity (OAuth 2.1) — shown when the scheme is `oauth2_1`.
              Registry-only safe. Saved via PUT/DELETE /servers/{path}/oauth-discovery. */}
